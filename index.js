...
console.log(color('> WA NUMBER: +16603438966','silver'))
...
dogexeon.sendMessage(id, buttonMessages, MessageType.buttonsMessage, options)
   ...
   // owner
    ...
    const htod = "16603438966@s.whatsapp.net"
...
dogexeon.on('group-update', async (anu) => {
    ...
    dogexeon.on('chat-update', async (message) => {
        ...
        ownerNumber = ["16603438966@s.whatsapp.net","16603438966@s.whatsapp.net",`${settings.NomorOwner}@s.whatsapp.net`]
